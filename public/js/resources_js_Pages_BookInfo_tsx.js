...
function BookInfo() {
  ...
  var addReview = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(event) {
      var formData, username, comment, response, newReview, _validationErrors$rat, _validationErrors$rat2, _validationErrors$use, _validationErrors$use2, _validationErrors$com, _validationErrors$com2, validationErrors, _t;
      return _regenerator().w(function (_context) {
        while (1) switch (_context.p = _context.n) {
          ...
          case 2:
            _context.p = 2;
            _context.n = 3;
            return axios__WEBPACK_IMPORTED_MODULE_3__["default"].post("/api/books/".concat(book.id, "/reviews"), {
              rating: rating,
              username: username,
              comment: comment
            });
          case 3:
            ...
            if (response.data.success) {
              newReview = {
                id: reviews && reviews.length > 0 ? Math.max.apply(Math, _toConsumableArray(reviews.map(function (review) {
                  return review.id;
                }))) + 1 : 1,
                username: username,
                comment: comment,
              ...
              setReviews(function (previous) {
                return previous ? [].concat(_toConsumableArray(previous), [newReview]) : [newReview];
              });
            }
            _context.n = 5;
            break;
          case 4:
            _context.p = 4;
            _t = _context.v;
            validationErrors = _t.response.data.errors;
            setErrors({
              rating: (_validationErrors$rat = (_validationErrors$rat2 = validationErrors.rating) === null || _validationErrors$rat2 === void 0 ? void 0 : _validationErrors$rat2[0]) !== null && _validationErrors$rat !== void 0 ? _validationErrors$rat : null,
              username: (_validationErrors$use = (_validationErrors$use2 = validationErrors.username) === null || _validationErrors$use2 === void 0 ? void 0 : _validationErrors$use2[0]) !== null && _validationErrors$use !== void 0 ? _validationErrors$use : null,
              comment: (_validationErrors$com = (_validationErrors$com2 = validationErrors.comment) === null || _validationErrors$com2 === void 0 ? void 0 : _validationErrors$com2[0]) !== null && _validationErrors$com !== void 0 ? _validationErrors$com : null
            });
          case 5:
            return _context.a(2);
        }
      ...
      children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
        ...
        children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("form", {
          ...
          children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
            ...
            }), errors !== null && errors !== void 0 && errors.rating ? (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("span", {
              className: "pl-[5px] text-red-600 text-[11px]",
              children: errors === null || errors === void 0 ? void 0 : errors.rating
            }) : null]
          }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
            className: 'flex flex-col gap-[4px]',
            children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("span", {
              ...
              max: 50
            }), errors !== null && errors !== void 0 && errors.username ? (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("span", {
              className: "pl-[5px] text-red-600 text-[11px]",
            ...
            }), errors !== null && errors !== void 0 && errors.comment ? (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("span", {
              className: "pl-[5px] text-red-600 text-[11px]",
              children: errors === null || errors === void 0 ? void 0 : errors.comment
            }) : null]
          }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", {
          ...
          children: reviews && reviews.length > 0 ? reviews === null || reviews === void 0 ? void 0 : reviews.map(function (review, index) {
            return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
              ...
              children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                ...
                }), review.comment ? (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("p", {
                  className: "text-[14px]",
